        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground">
              {t("about.director.title", "Director & CEO")}
            </h2>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="max-w-5xl mx-auto bg-card rounded-2xl overflow-hidden shadow-lg border border-border/50"
          >
            <div className="grid md:grid-cols-12 gap-0">
              <div className="md:col-span-5 lg:col-span-4 h-full min-h-[400px]">
                <img
                  src="/images/director.jpeg"
                  alt="Harshad V. Renapure - Director and CEO"
              ...
              <div className="md:col-span-7 lg:col-span-8 p-8 md:p-12 flex flex-col justify-center">
                <h3 className="text-2xl md:text-3xl font-serif font-bold text-foreground mb-2">
                  {t("about.director.name", "Harshad V. Renapure")}
                </h3>
                <p className="text-primary font-medium text-lg mb-6">
                  {t("about.director.title", "Director and CEO, BioScrap")}
                </p>
                <div className="text-muted-foreground leading-relaxed whitespace-pre-line text-lg space-y-4">
                  {(t("about.director.description", { returnObjects: true }) as string[]).map ? (
                    (t("about.director.description", { returnObjects: true }) as string[]).map((paragraph, idx) => (
                      <p key={idx}>{paragraph}</p>
                    ))
                  ) : (
                    <p>{t("about.director.description")}</p>
                  )}
                </div>
              </div>
            </div>
